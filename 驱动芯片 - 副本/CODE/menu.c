...
//	菜单显示
	...
	ips200_display_chinese(0, 224, 16, nom, info(show_index[0], menu[show_index[0]]), 0xB6DB);
	
	ips200_bgcolor = 0xB6DB;
	ips200_display_chinese(0, 256, 16, nom, info(show_index[1], menu[show_index[1]]), 0xFFFF);
	ips200_bgcolor = 0xFFFF;
	
	ips200_display_chinese(0, 288, 16, nom, info(show_index[2], menu[show_index[2]]), 0xB6DB);
